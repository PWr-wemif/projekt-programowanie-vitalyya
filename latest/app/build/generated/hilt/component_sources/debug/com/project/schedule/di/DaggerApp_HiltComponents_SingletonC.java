...
import com.project.schedule.MainActivity_MembersInjector;
import com.project.schedule.db.AppDb;
import com.project.schedule.fragments.ChangeLessonFragment;
import com.project.schedule.fragments.ChangeLessonFragment_MembersInjector;
import com.project.schedule.fragments.DayFragment;
import com.project.schedule.fragments.DayFragment_MembersInjector;
import com.project.schedule.fragments.MainFragment;
import com.project.schedule.fragments.MainFragment_MembersInjector;
...
public final class DaggerApp_HiltComponents_SingletonC {
  ...
  public static final class Builder {
     ...
     */
    @Deprecated
    public Builder firebaseRemoteConfigModule(
        FirebaseRemoteConfigModule firebaseRemoteConfigModule) {
      Preconditions.checkNotNull(firebaseRemoteConfigModule);
      return this;
    }
  ...
  private static final class FragmentCImpl extends App_HiltComponents.FragmentC {
    ...
    @Override
    public void injectChangeLessonFragment(ChangeLessonFragment changeLessonFragment) {
      injectChangeLessonFragment2(changeLessonFragment);
    }
    ...
    private ChangeLessonFragment injectChangeLessonFragment2(ChangeLessonFragment instance) {
      ChangeLessonFragment_MembersInjector.injectDb(instance, singletonCImpl.appDb());
      return instance;
    }

    @CanIgnoreReturnValue
    private DayFragment injectDayFragment2(DayFragment instance) {
      DayFragment_MembersInjector.injectGsonUtil(instance, GsonModule_ProvideGsonUtilFactory.provideGsonUtil());
      return instance;
    }

    @CanIgnoreReturnValue
    private MainFragment injectMainFragment2(MainFragment instance) {
      MainFragment_MembersInjector.injectCalendarUtil(instance, CalendarModule_ProvideCalendarFactory.provideCalendar());
      MainFragment_MembersInjector.injectLessonRepository(instance, singletonCImpl.lessonRepository());
      MainFragment_MembersInjector.injectFirebaseRemoteConfig(instance, FirebaseRemoteConfigModule_ProvideRemoteConfigFactory.provideRemoteConfig());
      MainFragment_MembersInjector.injectDb(instance, singletonCImpl.appDb());
      MainFragment_MembersInjector.injectGsonUtil(instance, GsonModule_ProvideGsonUtilFactory.provideGsonUtil());
      return instance;
    }
  }
  ...
  private static final class ActivityCImpl extends App_HiltComponents.ActivityC {
    ...
    private MainActivity injectMainActivity2(MainActivity instance) {
      MainActivity_MembersInjector.injectLessonRepository(instance, singletonCImpl.lessonRepository());
      return instance;
    }
  }
  ...
  private static final class SingletonCImpl extends App_HiltComponents.SingletonC {
    ...
    private LessonRepository lessonRepository() {
      return DbModule_ProvideRepositoryFactory.provideRepository(appDb());
    }
