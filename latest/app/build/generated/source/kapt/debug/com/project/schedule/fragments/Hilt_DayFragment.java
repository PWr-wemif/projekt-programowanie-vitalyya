...
public abstract class Hilt_DayFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DayFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DayFragment_GeneratedInjector) this.generatedComponent()).injectDayFragment(UnsafeCasts.<DayFragment>unsafeCast(this));
    }
  }
