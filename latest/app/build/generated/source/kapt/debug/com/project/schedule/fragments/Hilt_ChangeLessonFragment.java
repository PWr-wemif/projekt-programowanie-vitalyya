...
public abstract class Hilt_ChangeLessonFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ChangeLessonFragment() {
    super();
  }

  Hilt_ChangeLessonFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ChangeLessonFragment_GeneratedInjector) this.generatedComponent()).injectChangeLessonFragment(UnsafeCasts.<ChangeLessonFragment>unsafeCast(this));
    }
  }
